...
namespace SGGames.Script.EditorExtensions
{
    public class QuickMenuEditor 
    {
        ...
        private static void AddEnemyController(GameObject main)
        {
            ...
            var gameEventAsset = AssetDatabase.LoadAssetAtPath("Assets/Data/Events/Game Event.asset", typeof(GameEvent));
            var gameEventField = typeof(EnemyController).GetField("m_gameEvent", BindingFlags.NonPublic | BindingFlags.Instance);
            gameEventField.SetValue(controller, gameEventAsset);
            
            var permissionField = typeof(EnemyController).GetField("m_isPermit", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        private static void AddHealthComponent(GameObject main)
        {
            ...
            var healthPermissionField = typeof(EnemyHealth).GetField("m_isPermit", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        private static void AddMovementComponent(GameObject main)
        {
            ...
            var movementPermissionField = typeof(EnemyMovement).GetField("m_isPermit", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        private static void AddBodyDamageGameObject(GameObject main)
        {
            ...
            var targetMaskField = typeof(DamageHandler).GetField("m_targetMask", BindingFlags.NonPublic | BindingFlags.Instance);
